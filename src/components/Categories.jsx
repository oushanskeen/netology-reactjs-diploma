...
const Categories = ({
  ...
  []);
  useEffect(() => 
    onGetItems(address(category.id))
  ,[category]);
  console.log(`
  ...
  return (
    <div style={box}>
      <div style={box}>
        <div style={box}>
          {JSON.stringify(categoriesState)}
        </div>
        <div style={box}>
      ...
      <div style={box}>
        { categories.map(e => (
            <button onClick={() => onSetCategory(e)}
          >
            {JSON.stringify(e)}
          </button>
        ))}
...
const mapDispatchToProps = _dispatch => ({
  onGetCategories: categories => 
    _dispatch(categoriesActions.getCategories()),
  onGetItems: tail =>
    _dispatch(itemsActions.getItems(tail)),
  onSetCategory: category => 
    _dispatch(categoriesActions.setCategory(category)),
  onIncrementOffset: () =>
    _dispatch(categoriesActions.incrementOffset())
});
